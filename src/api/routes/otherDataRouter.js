...
otherDataRouter.post("/get-gpu-presets", OtherDataController.getGPUPresets);
...
//
otherDataRouter.post("/edit-gpus-for-flight-sheets-mupltiple", OtherDataController.editGpusForFlightSheetsMupltiple);
