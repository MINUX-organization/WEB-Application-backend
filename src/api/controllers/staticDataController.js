...
class StaticDataController {
    static getFullData(req, res, next) { // reformated
    ...
    static getHarddriveData(req, res, next) { // reformated
    ...
    static getMinersData(req, res, next) { // added
